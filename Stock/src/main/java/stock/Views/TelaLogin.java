...
public class TelaLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mensagemErro = new javax.swing.JOptionPane();
        ...
        txtLogin.setFont(new java.awt.Font("Liberation Sans", 0, 18)); // NOI18N
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/stock/Views/outline_person_black_24dp.png"))); // NOI18N

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/stock/Views/outline_lock_black_24dp.png"))); // NOI18N

        BtnLogar.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        BtnLogar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/stock/Views/outline_login_black_24dp.png"))); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGap(138, 150, Short.MAX_VALUE))
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel3Layout.createSequentialGroup()
                                        .addGap(18, 18, 18)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGap(99, 99, 99)
                        .addComponent(BtnLogar, javax.swing.GroupLayout.PREFERRED_SIZE, 177, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, Short.MAX_VALUE))))
        );
    ...
    private void LogaSistema(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LogaSistema
        ...
        String logou = login.Loga(usuario);
        
        if(logou == "Sucesso"){           
            this.LimpaCamposTela();
            areacomum.NomeUsuario=usuario.login;
            TelaPrincipal menuinicial = new TelaPrincipal(this);
            this.setVisible(false);
            menuinicial.setVisible(true);
        }
        else{
            mensagemErro.showMessageDialog(null,logou);
        }      
    }//GEN-LAST:event_LogaSistema
    ...
    private javax.swing.JOptionPane mensagemErro;
